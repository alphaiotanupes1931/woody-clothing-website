      ...
      <main>
        ...
        <FadeIn>
          <section className="relative w-full min-h-[60vh] md:h-[70vh] md:min-h-[400px] overflow-hidden bg-foreground flex flex-col md:flex-row items-center">
            ...
            <div className="absolute top-0 left-0 right-0 h-[12%] bg-gradient-to-b from-background/40 to-transparent z-[1]" />
            {/* Bottom blend to white */}
            <div className="absolute bottom-0 left-0 right-0 h-[12%] bg-gradient-to-t from-background/40 to-transparent z-[1]" />
