        ...
        {items.length > 0 && (
          <div className="px-6 py-5 border-t border-border space-y-3 pb-[calc(1.25rem+env(safe-area-inset-bottom,0px))]">
            ...
            <button
              ...
              className="w-full bg-foreground text-background py-4 text-xs font-semibold tracking-[0.2em] uppercase hover:bg-foreground/90 transition-colors active:scale-[0.98] active:bg-foreground/80 flex items-center justify-center gap-2"
            >
              Checkout
            </button>
          </div>
